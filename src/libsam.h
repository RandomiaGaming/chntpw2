...
// Account V, contains machine SID and a lot of unknown stuff
...
struct user_V
{
	...
	char data[4];				// Data starts here. All pointers above is relative to this, that is V + 0xCC
};
...
struct group_C
{
	...
	char data[];	  // 0x34 - data starts here. pointers above are offset from this
};
